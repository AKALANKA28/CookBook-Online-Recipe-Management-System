...
if (isset($_POST['submit'])) {
   ...
   $insert_query = "INSERT INTO `recipe` (id, ChefID, title, image, cuisine, ingredients, directions, preparation_time) VALUES ('$id' ,'$chef_id', '$title', '$rename', '$cuisine', '$ingredients', '$directions', '$ptime')";
   $insert_result = mysqli_query($conn, $insert_query);
   
   if ($insert_result) {
      $success_msg[] = 'Registered successfully!';
   } else {
      $warning_msg[] = 'Error occurred while registering!';
   }
}
?>
...
<body>
   ...
   function addIngredientInput() {
      ...
      var inputCount = container.childElementCount;
      ...
      if (inputCount < 100) {
         ...
         input.required = true;
         input.placeholder = "ingredient " + (inputCount + 1);
